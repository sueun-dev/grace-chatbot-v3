...
> **Note:** This project evolved from grace-chatbot-v2 (Sep 2025), which established the core chatbot architecture and CSV logging system. v3 is a complete rebuild with enhanced scenario simulations, improved UI/UX, and production-grade deployment.
