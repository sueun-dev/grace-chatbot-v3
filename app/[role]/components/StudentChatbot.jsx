...
const Sidebar = ({ showSidebar }) => {
  return (
    <div
      className={clsx(
        "absolute top-0 left-0 bottom-0 overflow-hidden translate-x-[-100%] lg:static lg:w-0 lg:max-w-0 transition-all duration-300 z-index-10 h-full rounded-[16px] border-[1px] border-[#F0F2F5] flex flex-col justify-center items-center box-shadow bg-[url('/student-bg.png')] bg-cover bg-center",
        showSidebar &&
